    ...
    return (
        <>
            ...
            <main>
                ...
                <p className="legal-sub-header">1. Reasons for Collecting Data</p>
                <article className="legal-text">
                    <p>
                ...
                <p className="legal-sub-header">2. What Data Is Being Collected</p>
                <article className="legal-text">
                    <p>
                ...
                <p className="legal-sub-header">3. How Personal Data Is Used</p>
                <article className="legal-text">
                    <p>
                ...
                <p className="legal-sub-header">4. Storage Period</p>
                <article className="legal-text">
                ...
                <p className="legal-sub-header">5. Use of Local Storage</p>
                <article className="legal-text">
