...
const SignIn = () => {
  const SignInMainBottomSpace: any = {
  ...
  const [passwordResetAnimation, setPasswordResetAnimation] = useState({
    //animation when opening password reset modal
  ...
  function openPasswordReset() {
    //function for opening the password reset modal
      ...
      {!user ? (
        <>
          ...
          {passwordReset && (
            <>
              <SignInPasswordReset
                onAnimation={passwordResetAnimation}
                onClosePasswordReset={closePasswordReset}
              />
